...
int main() {
  ...
  GLFWwindow *window =
      glfwCreateWindow(SCR_WIDTH, SCR_HEIGHT, "Particle System", NULL, NULL);
  if (window == NULL) {
  ...
  Shader particleShader(RESOURCES_PATH "system.vert",
                        RESOURCES_PATH "system.frag");
  ...
  {
    float floorVertices[] = {-3.0f, 0.0f, -3.0f, 3.0f,  0.0f, -3.0f,
